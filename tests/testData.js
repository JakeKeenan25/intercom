exports.readFile_input = 'https://s3.amazonaws.com/intercom-take-home-test/customers.txt';
exports.readFile_output = [ '{"latitude": "52.986375", "user_id": 12, "name": "Christina McArdle", "longitude": "-6.043701"}',
...
exports.calculate_input = {
	lat: '52.986375',
	long: '-6.043701'
}
exports.calculate_output = '41.7687255008362';

exports.sort2DArray_input = [[12, 'AAA'], [58, 'BBB'], [28, 'CCC'],[18, 'DDD']];
exports.sort2DArray_output = [[12,'AAA'], [18, 'DDD'], [28, 'CCC'], [58, 'BBB']];

exports.getRadians_input = '2.986375';
exports.getRadians_output= '0.05212207644924566';

exports.greatCircleDistance_input = {
	latitude1: '53.339428',
	longitude1: '-6.257664',
	latitude2: '52.986375',
	longitude2: '-6.043701'
}
exports.greatCircleDistance_output = '41.7687255008362';